...
# Start live stream
webrtc_streamer(key="face-detect", video_transformer_factory=FaceDetector,
                rtc_configuration=RTC_CONFIGURATION, media_stream_constraints={"video": True, "audio": False})
